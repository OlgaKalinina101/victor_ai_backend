...
Этот репозиторий - не для разработчиков. Он для пользователей. И будет тихо передаваться личными ссылками тем, кому он действительно нужен — чтобы не привлекать ненужного шума. Я постоянно работаю над упрощением процесса установки, но пока, установка прямо требует или готовности вникать во все гайды и огромного желания, или наличия связи со мной в telegram, или уровня junior. 

#### На каждый пункт здесь есть подробный гайд. Все в ваших руках и зависит только от вас.  

Этот проект распространяется под лицензией **GNU Affero General Public License v3.0** (AGPL-3.0). Это значит, что если вы хотите забрать что то в коммерческий проект, вы обязаны дать пользователям ссылку на этот репозиторий, чтобы каждый из них имел возможность развернуть его самостоятельно. 
...
#### Если вы не разработчик - не бойтесь. Я старалась писать все гайды так, как хотела бы увидеть их сама, много лет назад, в очередной раз теряющая смыслы и самое важное.  
