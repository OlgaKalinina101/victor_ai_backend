...
Этот репозиторий - не для разработчиков. Он для пользователей. И будет тихо передаваться личными ссылками тем, кому он действительно нужен — чтобы не привлекать ненужного шума. Пока, установка прямо требует уровня junior, или огромного желания установить это в любом случае, ценой чего угодно. 
