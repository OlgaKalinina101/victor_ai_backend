...
#### Примеры реального диалога - старт коммуникации с нулевым trust level с default persona, настроенного **идеально под меня**. Для большей части тех, кто щупал демо, он слишком отстраненный и занудный. Отдельные примеры на максимальном trust level выложены в [system&context.md](docs/system%26context.md)
