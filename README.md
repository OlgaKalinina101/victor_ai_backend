...
Этот репозиторий - не для разработчиков. Он для пользователей. И будет тихо передаваться личными ссылками тем, кому он действительно нужен — чтобы не привлекать ненужного шума. Я постоянно работаю над упрощением процесса установки, но пока, установка прямо требует огромного желания получить свой цифровой дом, или наличия связи со мной в telegram, или уровня junior.  
...
- [🚀 Быстрый старт, к чему быть готовым](#steps)
