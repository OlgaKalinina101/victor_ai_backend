...
Этот репозиторий - не для разработчиков. Он для пользователей. И будет тихо передаваться личными ссылками тем, кому он действительно нужен — чтобы не привлекать ненужного шума. Я постоянно работаю над упрощением процесса установки, но пока, установка прямо требует огромного желания установить это ценой чего угодно, или наличия связи со мной в telegram, или уровня junior.  
...
- [🚀 Что вам понадобится, чтобы установить этот репозиторий](#quickstart)
