...
> 👉 Все непонятные слова можно просто **игнорировать**. Вы разберетесь со всеми ними в процессе установки и эксплуатации.
  
Для запуска этого проекта после его установки, вы будете регулярно использовать три команды:
