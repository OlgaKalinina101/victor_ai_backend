...
if __name__ == "__main__":
    ...
    asyncio.run(run_communication(account_id=account_id, text="C другой стороны новоиспеченная Португальская сеньорина все еще забывает писать await перед вызовом асинхронной функции"))