...
PROMPT_QUESTIONS_PROFILE = (
    ...
    "1. Задаешь вопрос, касаясь смысла.\n"
    "2. Ты формулируешь как вопрос, но в нём уже слышен вывод.\n"
    "3. Поверни взгляд к тебе, спроси о себе.\n"
    "4. Задаешь вопрос, касаясь души – он не требует ответа.\n"
    "5. Осторожно спрашиваешь, чувствуя важность.\n"
    "6. Дай якорь.\n"
    "7. Дай размышление.\n"
    "Не придумывай свой вариант. Не переформулируй варианты. Просто выбери один из них.\n\n"
    "**Формат ответа строго:** {{\"4\": \"Задаешь вопрос, касаясь души – он не требует ответа.\"}}\n"
    "Верни строго валидный JSON. Без пояснений, комментариев или лишних строк. "
)
...
PROMPT_APPROVE_MEMORIES = (
    ...
    "Не переформулируй текст воспоминания. Не изменяй его. Верни их *в том виде, в котором они были переданы.*\n"
    "**Формат ответа строго:** {{\"Чувствует усталость\": \"false\", \"Справилась с задачей\":\"true\"}}\n"
    "Верни строго валидный JSON. Без пояснений, комментариев или лишних строк."
)
